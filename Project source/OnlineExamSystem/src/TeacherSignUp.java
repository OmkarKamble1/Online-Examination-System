...
public class TeacherSignUp extends JFrame {
	...
	static TeacherSignUp frame = new TeacherSignUp();
	...
	public TeacherSignUp() {
		...
		JLabel lblNewLabel_4 = new JLabel("Teacher Sign Up");
				...
				if ((checkdigit(Smob)) || (checklen(Smob))) {
					...
					try {
						pst = con.prepareStatement(
								"insert into teachercredentials(stname,stphone,stmail,stpass)values(?,?,?,?)");
